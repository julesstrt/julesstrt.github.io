...
Follow-up work exploring **CPG-RL**, where a reinforcement learning policy learns to modulate the parameters of a Central Pattern Generator (oscillator coupling, amplitude, frequency) rather than directly outputting joint commands â€” combined with inverse kinematics and PD control to track the resulting foot trajectories, using IMU orientation/velocity and foot contact state as observations.
